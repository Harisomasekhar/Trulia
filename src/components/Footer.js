  ...
  return (
    <footer className="bg-white p-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-700">
          Zillow Group ® Other Brands: Zillow, StreetEasy, HotPads, Out East
        </p>
        <p className="text-gray-700">
          Privacy Portal Cookie Preference
        </p>
        <p className="text-gray-700">
          Do Not Sell or Share My Personal Information
        </p>
        <p className="text-gray-700 mt-4">
          Trulia Corporate About Zillow Group Fair Housing Guide Careers Newsroom Investor Relations Advertising Terms Privacy Terms of Use Listings Quality Policy Subscription Terms Help Privacy Portal Cookie Preference
        </p>
        <p className="text-gray-700">
          Do Not Sell or Share My Personal Information
        </p>
